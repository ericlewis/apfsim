    ...
    return {
        ...
        "memory_model": {
            ...
            "counter_ports": [
                ...
                "apfsim_sdram_first_rom_mismatch_expected",
                "apfsim_sdram_first_rom_mismatch_actual",
                "apfsim_sdram_first_rom_mismatch_dqm",
                "apfsim_sdram_first_rom_unwritten_expected",
                "apfsim_sdram_first_rom_unwritten_dqm",
...
`endif
    ...
    apfsim_sdram_pin_model #(
        ...
        .first_rom_mismatch_expected(apfsim_sdram_first_rom_mismatch_expected),
        .first_rom_mismatch_actual(apfsim_sdram_first_rom_mismatch_actual),
        .first_rom_mismatch_dqm(apfsim_sdram_first_rom_mismatch_dqm),
        .first_rom_unwritten_expected(apfsim_sdram_first_rom_unwritten_expected),
        .first_rom_unwritten_dqm(apfsim_sdram_first_rom_unwritten_dqm),
